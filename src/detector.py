...
from .first_stage import run_first_stage, run_first_stage_tensor
...
def detect_faces(image,
    ...
    for s in scales:
        if cpu_method:
            ...
            img_data = F.interpolate(img.unsqueeze(0), size=(sh, sw), mode='bilinear', align_corners=False)
            boxes = run_first_stage_tensor(img_data.squeeze(0), pnet, scale=s, threshold=thresholds[0])
